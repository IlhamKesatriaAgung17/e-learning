<aside class="main-sidebar sidebar-dark-primary elevation-4 " style="background-color: blue">
    ...
    <a href="{{ route('admin.dashboard') }}" class="brand-link">
        <img src="{{ asset('img/favicon.jpg') }}" alt="Logo Ilham" class="brand-image img-circle elevation-3" style="opacity: .8">
        <span class="brand-text font-weight-light"><strong>E_AMIKBNC</strong></span>
    </a>
