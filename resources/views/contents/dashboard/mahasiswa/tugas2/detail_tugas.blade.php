                ...
                <table class="table table-bordered text-center">
                    <table align="left" cellpadding="4" width="100%" >
                        ...
                        <div class="row no-print">
                            &nbsp;&nbsp;&nbsp;
                            <h4>
                                <small style="float: left">Selesai : {{$detailtugas2->tgl_selesai}}</small>
                            </h4>
                          <div class="col-12">
                            {{-- <a href="/img/tugas/{{$detailtugas->file}}" rel="noopener" target="_blank" class="btn btn-default"><i class="fas fa-print"></i> Print</a> --}}
                            <a href="/img/tugas/semester2/{{$detailtugas2->file}}"><button class="btn btn-primary  float-left" type="button"> <i class="fas fa-download"></i> Download Tugas {{$detailtugas2->nama_tugas}}</button></a>
                          </div>
                        </div>
                    </table>
                </table>
