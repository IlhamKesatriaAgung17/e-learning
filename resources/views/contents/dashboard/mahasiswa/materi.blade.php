...
<div class="content-wrapper">
    <div class="container-fluid">
        <br>
        <h2 class="mb-3">MATERI KULIAH</h2>
            ...
            <div class="row">
              <div class="col-md-12 col-lg-6 col-xl-4">
                ...
                <div class="card-body p-1">
                    ...
                    <br>
                    <a href="{{ route('mahasiswa.data-materi.semester-1')}}" class="text-primary">Detail</a>
                </div>
              </div>
              <div class="col-md-12 col-lg-6 col-xl-4">
                <div class="card mb-2">
                ...
                <div class="card-body p-1">
                    ...
                    <br>
                    <a href="{{ route('mahasiswa.data-materi.semester-2')}}" class="text-primary">Detail</a>
                </div>
              </div>
              <div class="col-md-12 col-lg-6 col-xl-4">
                <div class="card mb-2">
                ...
                <div class="card-body p-1">
                    ...
                    <br>
                    <a href="{{ route('mahasiswa.data-materi.semester-3')}}" class="text-primary">Detail</a>
                </div>
              </div>
            </div>
          </div>
