       ...
       <div class="container-fluid">
        <div class="card">
           <div class="card-header">
            <h3 class="card-title">Tugas Semester 3</h3>
            <a href="{{route('tugas3.create')}}" class="btn btn-success btn-sm float-right">Tambah Data <i class="fas fa-plus-square"></i></a>
                ...
                <table class="table table-bordered">
                    ...
                    <tr class="bg-light text-center">
                        ...
                        <td class="text-center">
                            <div class="btn-group">
                            <a href="{{route('tugas3.show',['tugas3' => $items->id]) }}"><i class="fas fa-eye btn btn-primary btn-sm"></i></a>
                            &nbsp;
                            <a href="{{route('tugas3.edit',['tugas3' => $items->id]) }}"><i class="fas fa-edit btn btn-warning btn-sm"></i></a>
                            &nbsp;
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    <form method="POST" action="{{ route('tugas3.destroy', $items->id) }}">
                                        @method('DELETE')
                                        @csrf
