            ...
            @else
                <table class="table table-bordered">
                    ...
                    <tr class="bg-light text-center">
                        ...
                        <td><a href="{{ url('/img/pengumpulantugas/semester3/'.$items->file)}}"><button class="btn btn-primary" type="button">Download File</button></a></td>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    <form method="POST" action="{{ route('dosen.data-pengumpulan-tugas3.destroy3', $items->id) }}">
                                        @method('DELETE')
                                        @csrf
