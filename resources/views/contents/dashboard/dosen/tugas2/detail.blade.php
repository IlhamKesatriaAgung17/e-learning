    ...
    <div class="content text-dark">
       <div class="card card-info card-outline">
            <div class="card-header bg-success">
                <h3>Detail Tugas<a href="{{route('tugas2.index')}}" class="btn btn-primary float-right">Kembali</a></h3>
            </div>
                ...
                <table class="table table-bordered text-center">
                    ...
                    {{-- <div class="invoice p-3 mb-3">
                        ...
                        <div class="row"> --}}
                          <div class="col-12">
                            <h4>
                              <i class="fas fa-globe"></i> {{$tugas2->nama_tugas}}
                              <small class="float-right">Mulai : {{$tugas2->tgl_mulai}}</small>
                            </h4>
                          </div>
                          <!-- /.col -->
                        {{-- </div> --}}
                        ...
                        <div class="row no-print">
                            &nbsp;&nbsp;&nbsp;
                            <h4>
                                <small style="float: left">Selesai : {{$tugas2->tgl_selesai}}</small>
                            </h4>
                          <div class="col-12">
                            {{-- <a href="/img/tugas/{{$tugas2->file}}" rel="noopener" target="_blank" class="btn btn-default"><i class="fas fa-print"></i> Print</a> --}}
                            <a href="/img/tugas/semester2/{{$tugas2->file}}"><button class="btn btn-primary  float-left" type="button"> <i class="fas fa-download"></i> Download Tugas {{$tugas2->nama_tugas}}</button></a>
                          </div>
                        </div>
                        {{-- </div>
                      </div> --}}
