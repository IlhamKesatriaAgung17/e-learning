       ...
       <div class="container-fluid">
        <div class="card">
           <div class="card-header">
            <h3 class="card-title">Tugas Semester 2</h3>
            <a href="{{route('tugas2.create')}}" class="btn btn-success btn-sm float-right">Tambah Data <i class="fas fa-plus-square"></i></a>
           ...
           <div class="card-body table-responsive p-0">
            ...
            @else
                <table class="table table-bordered">
                    ...
                    @foreach ($dttugas2 as $no => $items )
                    <tr class="bg-light text-center">
                        <td>{{$dttugas2->firstitem()+$no}}</td>
                        ...
                        <td class="text-center">
                            <div class="btn-group">
                            <a href="{{route('tugas2.show',['tugas2' => $items->id]) }}"><i class="fas fa-eye btn btn-primary btn-sm"></i></a>
                            &nbsp;
                            <a href="{{route('tugas2.edit',['tugas2' => $items->id]) }}"><i class="fas fa-edit btn btn-warning btn-sm"></i></a>
                            &nbsp;
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    <form method="POST" action="{{ route('tugas2.destroy', $items->id) }}">
                                        @method('DELETE')
                                        @csrf
