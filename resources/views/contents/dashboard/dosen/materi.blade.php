...
<div class="content-wrapper">
    <div class="container-fluid">
        <br>
        <h5 class="mb-3">DATA MATERI KULIAH</h5>
            ...
            <div class="row">
              <div class="col-md-12 col-lg-6 col-xl-4">
                ...
                <div class="card-body p-1">
                    ...
                    <br>
                    <a href="{{ route('materi.index')}}" class="text-primary">Detail</a>
                </div>
              </div>
              <div class="col-md-12 col-lg-6 col-xl-4">
                <div class="card mb-2">
                ...
                <div class="card-body p-1">
                    ...
                    <br>
                    <a href="{{ route('materi2.index')}}" class="text-primary">Detail</a>
                </div>
              </div>
              <div class="col-md-12 col-lg-6 col-xl-4">
                <div class="card mb-2">
                ...
                <div class="card-body p-1">
                    ...
                    <br>
                    <a href="{{ route('materi3.index')}}" class="text-primary">Detail</a>
                </div>
              </div>
            </div>
          </div>
