...
<div class="content-wrapper">
    <div class="container-fluid">
        <br>
        <h5 class="mb-3">DATA PENGUMPULAN TUGAS KULIAH</h5>
            ...
            <div class="row">
              <div class="col-md-12 col-lg-6 col-xl-4">
                ...
                <div class="card-body p-1">
                    ...
                    <br>
                    <a href="{{ route('dosen.data-pengumpulan-tugas1')}}" class="text-primary">Detail</a>
                </div>
              </div>
              <div class="col-md-12 col-lg-6 col-xl-4">
                <div class="card mb-2">
                ...
                <div class="card-body p-1">
                    ...
                    <br>
                    <a href="{{ route('dosen.data-pengumpulan-tugas2')}}" class="text-primary">Detail</a>
                </div>
              </div>
              <div class="col-md-12 col-lg-6 col-xl-4">
                <div class="card mb-2">
                ...
                <div class="card-body p-1">
                    ...
                    <br>
                    <a href="{{ route('dosen.data-pengumpulan-tugas3')}}" class="text-primary">Detail</a>
                </div>
              </div>
            </div>
          </div>
