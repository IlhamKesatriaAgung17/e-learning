       ...
       <div class="card card-info card-outline">
           ...
           <div class="card-body">
                <table class="table table-bordered text-center">
                   <form action="{{route('tugas.update', $dttugas = $tuga->id)}}" method="POST" enctype="multipart/form-data">
                        @method('patch')
                        @csrf
                        <div class="form-group">
                            <label for="nama_tugas">Nama Tugas</label>
                         <input type="text" id="nama_tugas" name="nama_tugas" class="form-control" value="{{$tuga->nama_tugas}}">
                        </div>
                        ...
                        <div class="form-group">
                            <label for="tgl_mulai">Mulai</label>
                             <input type="datetime-local" id="tgl_mulai" name="tgl_mulai" class="form-control" value="{{$tuga->tgl_mulai}}">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <br>
                            <a href="/img/tugas/{{$tuga->file}}"><button class="btn btn-primary" type="button">Download Tugas {{$tuga->nama_tugas}}</button></a>
                        </div>

                       <div class="form-group" style="float: right">
                        <a href="{{route('tugas.index')}}" class="btn btn-danger">Batal</a>&nbsp;&nbsp;<button type="submit" class="btn btn-success">Simpan Data</button>
                       </div>
                   </form>
                </table>
           </div>
