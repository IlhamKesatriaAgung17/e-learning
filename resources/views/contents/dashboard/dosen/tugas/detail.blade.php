    ...
    <div class="content text-dark">
       <div class="card card-info card-outline">
            <div class="card-header bg-success">
                <h3>Detail Tugas<a href="{{route('tugas.index')}}" class="btn btn-primary float-right">Kembali</a></h3>
            </div>
                ...
                <table class="table table-bordered text-center">
                    ...
                    {{-- <div class="invoice p-3 mb-3">
                        ...
                        <div class="row"> --}}
                          <div class="col-12">
                            <h4>
                              <i class="fas fa-globe"></i> {{$tuga->nama_tugas}}
                              <small class="float-right">Mulai : {{$tuga->tgl_mulai}}</small>
                            </h4>
                          </div>
                          <!-- /.col -->
                        {{-- </div> --}}
                        ...
                        <div class="row no-print">
                            &nbsp;&nbsp;&nbsp;
                            <h4>
                                <small style="float: left">Selesai : {{$tuga->tgl_selesai}}</small>
                            </h4>
                          <div class="col-12">
