  ...
  <div class="container">
    <div class="section-title extra">
      <h2 class="title">Pertanyaan Yang Sering Ditanyakan</h2>
      <p>
        Berikut ini beberapa pertanyaan yang sering ditanyakan oleh pengguna e-Amik
      </p>
    </div>
    <div class="row">
      <div class="col-lg-6">
      ...
      <div class="col-lg-6 d-flex">
        <div class="faq-img">
          <img src="{{ asset('landing/assets/images/faq.png')}}" alt="">
        </div>
      </div>
    </div>
  </div>
